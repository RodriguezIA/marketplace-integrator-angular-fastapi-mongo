...
import { InventoryService } from 'app/modules/user/ecommerce/services/inventory.service';
import { InventoryBrand, InventoryCategory, InventoryPagination, InventoryProduct, InventoryTag, InventoryVendor } from 'app/modules/user/ecommerce/interfaces/inventory.types';
